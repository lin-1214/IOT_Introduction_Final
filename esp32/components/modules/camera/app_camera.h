...
#define LOW_XCLK_FREQ_HZ 10000000
 ...
 * @param fb_count     Number of frame buffers to be allocated. If more than one, then each frame
 * will be acquired (double speed)
 */
void register_camera(const pixformat_t pixel_fromat, const framesize_t frame_size,
                     const uint8_t fb_count, const QueueHandle_t frame_o);
